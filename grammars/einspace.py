...
mlp_grammar = {
    ...
    "computation_fn": computation_fns_mlp,
}


# def build_mlp_grammar():
#     # 1)  sequential / computation_module
#     network = {
#         "options": [
#             sequential_module,        # sequential_module 1
#             sequential_module_4,      # sequential_module 4
#             sequential_module_8,      # sequential_module 8
#         ],
#         "probs": [0.34, 0.33, 0.33],  # weight
#     }
#
#     # 2) module level：no branch/routing，only sequential or computation
#     module = {
#         "options": [
#             sequential_module,
#             sequential_module_4,
